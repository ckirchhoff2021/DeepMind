...
from framework.deepspeed_classify import DeepSpeedTrainInstance
...
def train_cifar10():
    ...
    x0, y0 = train_set[0]
    print(x0.shape)
    summary_folder = '/home/cx/A100/output/deepspeed/summary'
    output = '/home/cx/A100/output/deepspeed/ckpts'
    log_file = '/home/cx/A100/output/deepspeed/log/cifar10.log'
    train_instance = DeepSpeedTrainInstance(train_set, test_set, epochs=30, device_ids=[0, 1, 2, 3],
                                            train_batch_size=512, test_batch_size=256,
                                            summary_folder=summary_folder, output_folder=output,
                                            log_file=log_file)
    model = resnet50()
    train_instance.run(model)
